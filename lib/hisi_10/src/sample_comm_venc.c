...
******************************************************************************/
HI_S32 SAMPLE_COMM_VENC_Start(VENC_CHN VencChn, PAYLOAD_TYPE_E enType, VIDEO_NORM_E enNorm, PIC_SIZE_E enSize, SAMPLE_RC_E enRcMode, HI_U32  u32Profile, ROTATE_E enRotate, HI_U32 frameRate, HI_U32 bitRate)
{
    HI_S32 s32Ret;
    ...
    switch (enType)
    {
        case PT_H264:
        {
            ...
            if (SAMPLE_RC_CBR == enRcMode)
            {
                ...
                stH264Cbr.u32Gop            = frameRate; //(VIDEO_ENCODING_MODE_PAL == enNorm) ? 25 : 30;
            ...
            else if (SAMPLE_RC_VBR == enRcMode)
            {
                ...
                stH264Vbr.u32Gop = frameRate ;// (VIDEO_ENCODING_MODE_PAL == enNorm) ? 25 : 30;
                stH264Vbr.u32StatTime = 1;
                stH264Vbr.u32SrcFrmRate = (VIDEO_ENCODING_MODE_PAL == enNorm) ? 25 : 30;
				stH264Vbr.fr32DstFrmRate = frameRate;// (VIDEO_ENCODING_MODE_PAL == enNorm) ? 25 : 30;
